  ...
  function showLocation(arrayOfObj) {
    for (let i = 0; i < arrayOfObj.length; i++) {
      ...
      for (let j = 0; j < star; j++) {
        imgStarString +=
          '<img src = "https://blake5kh.files.wordpress.com/2012/09/star.jpg" width="15px">';
      }
      for (let j = star; j < 5; j++) {
        imgStarString +=
          '<img src = "https://www.freeiconspng.com/uploads/gold-star-empty-image-icon-23.png" width="15px">';
      }
...
//     select.querySelector("p").textContent = option.textContent;
